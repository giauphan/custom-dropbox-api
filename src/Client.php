...
class Client
{
    ...
    /**
     * @var RefreshableTokenProvider
     */
    private $RefreshableTokenProvider;
    ...
    public function contentEndpointRequest(string $endpoint, array $arguments, $body = '', bool $isRefreshed = false): ResponseInterface
    {
        ...
        try {
            ...
            if ($isRefreshed || !$this->tokenProvider instanceof RefreshableTokenProvider || !$this->refreshToken()) {
    ...
    public function refreshToken(): bool
    {
        ...
        try {
            ...
            if (isset($responseData['access_token'])) {
                ...
                $this->RefreshableTokenProvider = new InMemoryTokenProvider($newAccessToken);
                $this->tokenProvider = $this->RefreshableTokenProvider;
                // Assuming the token provider has a setAccessToken() method
